...
/// <summary>The visible window of the coordinate plane and the world↔screen maths.</summary>
public sealed class Viewport
{
    ...
    public void ZoomDecimal()
    {
        ...
        double half = w * 0.0125;                 // ~0.025 world units per pixel
        XMin = -half; XMax = half;
        double halfY = h * 0.0125;
    ...
    public Viewport Clone() => new()
    {
        ...
        XScl = XScl, YScl = YScl, PixelWidth = PixelWidth, PixelHeight = PixelHeight
    };

    public void CopyFrom(Viewport v)
    {
        XMin = v.XMin; XMax = v.XMax; YMin = v.YMin; YMax = v.YMax; XScl = v.XScl; YScl = v.YScl;
    }
}
